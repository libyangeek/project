...
# استخدام --break-system-packages لتجاوز قيود كالي الجديدة وضمان التثبيت المطلق
...
# 5. إعداد القبو السيادي (Sovereign Vault & Audit)
...
# 6. بروتوكول الخلود: إعداد خدمات systemd
