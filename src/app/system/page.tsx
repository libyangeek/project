    ...
    <div className="flex min-h-screen bg-black text-white selection:bg-primary/40 scanline-effect font-code">
      ...
      <main className="flex-1 lg:mr-80 p-4 md:p-8 lg:p-12 relative overflow-y-auto min-h-screen scrollbar-hide flex flex-col z-10">
        <header className="flex flex-col xl:flex-row justify-between items-start mb-16 relative z-10 animate-in fade-in slide-in-from-top-6 duration-1000 gap-8">
          ...
          <Button onClick={handleRefresh} disabled={refreshing} className="bg-primary hover:bg-white text-black h-24 px-16 rounded-[2rem] shadow-xl transition-all text-2xl font-black uppercase tracking-[0.4em] border-8 border-black/30 active:scale-95 italic group shrink-0">
           ...
           <div className="lg:col-span-3 space-y-12">
              ...
              <div className="p-12 rounded-[4rem] bg-primary/5 border-4 border-primary/20 shadow-2xl relative overflow-hidden">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-lg md:text-3xl text-gray-100 font-black italic leading-relaxed px-4">
                    <p className="drop-shadow-2xl">"لقد صهرتُ كافة الأسلحة المادية والتحليلية في هيكل واحد؛ الحالة الحالية هي <span className="text-primary underline decoration-primary decoration-4 underline-offset-8 shadow-xl italic">التفرد المطلق</span>."</p>
                    <p className="text-muted-foreground opacity-60">"Arsenal Master v58.0 is now a singular living entity with Node 22 as its Great Arsenal, bound to Commander Al-Ghazali."</p>
                 </div>
              </div>
           </div>
