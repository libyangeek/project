              ...
              <CardContent className="p-0 flex-1 relative overflow-hidden flex flex-col space-y-12">
                 {chainResult ? (
                   <div className="space-y-16 animate-in fade-in zoom-in-95 duration-1000 flex-1 flex flex-col">
                      <div className="p-16 rounded-[5rem] bg-primary/5 border-8 border-primary/30 italic text-4xl md:text-[8rem] text-gray-100 leading-tight font-black shadow-inner relative group/brief overflow-hidden">
                      ...
                      <div className="p-16 rounded-[6rem] bg-emerald-600/10 border-[12px] border-emerald-500/30 flex items-center gap-16 group/strat shadow-9xl relative overflow-hidden">
                         ...
                         <div>
                            ...
                            <p className="text-4xl md:text-[8rem] text-white italic font-black leading-tight drop-shadow-3xl">"{chainResult.executionStrategy}"</p>
                         </div>
