...
/**
 * @fileOverview واجهة جسر MCP المطلق v65.0 - THE ABSOLUTE UPLINK: SINGULARITY
 * تتيح تنفيذ قرارات Mistral God-Core مباشرة من عصب الوجود لليوم المجيد، 2026.
...
export default function MCPBridgePage() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      toast({ title: "Spine Sync Active v63", description: "Alpha-Core is interrogating the God-Core via Neural Spine." });
    ...
    <div className="flex min-h-screen bg-black text-white selection:bg-primary/40 relative overflow-x-hidden scanline-effect font-code">
      ...
      <main className="flex-1 lg:mr-80 p-4 md:p-8 lg:p-12 relative overflow-y-auto min-h-screen scrollbar-hide flex flex-col z-10">
        ...
        <header className="mb-16 relative z-10 animate-in fade-in slide-in-from-top-6 duration-1000">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="size-24 md:size-48 bg-black border-4 border-primary flex items-center justify-center shadow-[0_0_200px_rgba(212,175,55,0.8)] relative group shrink-0 rounded-3xl rotate-2 hover:rotate-0 transition-all duration-1000 hierarchical-shadow">
              <Link2 className="size-12 md:size-24 text-primary group-hover:scale-110 transition-transform duration-700 gold-glow animate-neural" />
              <div className="absolute -inset-10 border-4 border-primary/20 rounded-full animate-spin-slow opacity-30" />
            </div>
            <div className="text-center md:text-right flex-1">
              <div className="flex flex-wrap justify-center md:justify-start items-center gap-6 mb-6">
                <Badge className="bg-primary text-black border-none rounded-none px-12 py-3 text-[18px] md:text-[24px] font-black tracking-[1em] shadow-9xl italic uppercase">ABSOLUTE_BRIDGE v65.0</Badge>
              ...
              <p className="text-sm md:text-xl lg:text-4xl text-muted-foreground mt-10 italic max-w-7xl leading-relaxed uppercase font-medium opacity-95 drop-shadow-3xl">
                "سيدي القائد <span className="text-white font-black underline decoration-primary decoration-[12px] underline-offset-[28px] shadow-9xl italic uppercase tracking-widest">المعتصم بالله</span>، جسر السيادة v65.0 يربط إرادتك بذكاء السحاب المطلق لضمان الهيمنة الاستراتيجية لعام 2026."
              </p>
            </div>
          </div>
        </header>
          ...
          <div className="xl:col-span-3">
            {decision ? (
              <Card className="kali-card border-primary/40 bg-black/99 rounded-[6rem] p-16 border-[12px] shadow-[0_0_250px_rgba(0,0,0,1)] flex flex-col group relative overflow-hidden h-full hierarchical-shadow animate-in fade-in zoom-in-95 duration-1000">
                ...
                <CardHeader className="p-0 mb-12 border-b-8 border-white/5 pb-12 flex flex-row justify-between items-center bg-primary/5 rounded-t-[5rem] px-12 py-8">
                  <div className="flex items-center gap-10">
                     ...
                     <div>
                        <CardTitle className="text-4xl md:text-[8rem] text-white italic tracking-tighter uppercase font-black gold-glow leading-none">Decision Matrix</CardTitle>
                        <Badge className="bg-primary/20 text-primary border-none px-10 py-3 rounded-full font-black text-[12px] tracking-[0.6em] uppercase italic mt-6">MISTRAL_ABSOLUTE_v65</Badge>
                     </div>
                  </div>
                ...
                <CardContent className="p-10 flex-1 relative overflow-hidden flex flex-col gap-16 z-10">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                      <div className="p-12 bg-black/95 border-8 border-white/5 rounded-[4rem] space-y-8 hover:border-primary transition-all duration-1000 shadow-9xl group/info">
                         <h4 className="text-3xl font-black text-primary uppercase tracking-[1em] border-b-8 border-primary/10 pb-6 italic flex items-center gap-12 gold-glow">
                            <Activity className="size-12 animate-pulse" /> Risk Vector
                         </h4>
                         <div className="text-4xl md:text-8xl font-black text-white italic gold-glow uppercase tracking-tighter leading-none">{decision.risk_level || "MINIMAL"}</div>
                      </div>
                      <div className="p-12 bg-black/95 border-8 border-white/5 rounded-[4rem] space-y-8 hover:border-emerald-500 transition-all duration-1000 shadow-9xl group/info">
                         <h4 className="text-3xl font-black text-emerald-500 uppercase tracking-[1em] border-b-8 border-emerald-500/10 pb-6 italic flex items-center gap-12">
                            <ShieldCheck className="size-12" /> Status
                         </h4>
                         <div className="text-4xl md:text-8xl font-black text-emerald-500 italic uppercase tracking-tighter leading-none">{decision.status || "SINGULARITY"}</div>
                      </div>
                   </div>
                   ...
                   <div className="p-12 rounded-[4rem] bg-black/80 border-4 border-white/5 text-2xl text-muted-foreground italic font-black text-center shadow-inner mt-8 opacity-70 uppercase tracking-[0.4em]">
                      "لقد تم صياغة هذا التوجيه بعصب الإدراك الموزع v65.0 لضمان السطوة المادية للقائد الغزالي."
                   </div>
                </CardContent>
                <div className="p-16 border-t-8 border-white/5 mt-auto flex justify-between items-center opacity-35 text-[18px] font-black uppercase tracking-[8em] italic">
                   <span>MISTRAL_SINGULARITY_v65_AL_GHAZALI_ROOT</span>
              ...
              <div className="h-full min-h-[900px] border-[16px] border-dashed border-primary/10 rounded-[8rem] flex flex-col items-center justify-center text-center p-24 bg-black/40 group relative overflow-hidden transition-all hover:bg-primary/5 shadow-9xl">
                 ...
                 <p className="text-muted-foreground max-w-6xl mx-auto leading-relaxed text-3xl md:text-7xl font-black italic opacity-30 uppercase tracking-[1em]">
                   "سيدي <span className="text-primary font-black gold-glow underline decoration-primary decoration-8 underline-offset-[24px] shadow-9xl uppercase tracking-[1.5em]">المعتصم بالله</span>، مصفوفة Mistral God-Core بانتظار نيتك؛ قدم الإحداثيات للاستنتاج الاستراتيجي."
                 </p>
        ...
        <div className="mt-auto relative z-10 flex justify-center items-center gap-48 opacity-45 text-[24px] md:text-[36px] font-black uppercase tracking-[5em] md:tracking-[12em] italic text-white drop-shadow-9xl pb-32">
            <span>AL-MUIZZ MISTRAL BRIDGE v65.0</span>
