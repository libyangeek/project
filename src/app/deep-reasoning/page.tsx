                ...
                <CardHeader className="p-0 mb-8 border-b-2 border-white/5 pb-8 flex flex-row justify-between items-center bg-primary/5 rounded-t-3xl px-8 py-4">
                  <div className="flex items-center gap-6">
                     ...
                     <div>
                        ...
                        <Badge className="bg-primary/20 text-primary border-none px-4 py-0.5 rounded-full font-black text-[9px] tracking-[0.4em] uppercase italic mt-3">DEEPSEEK_LOG_v53</Badge>
                     </div>
                  </div>
