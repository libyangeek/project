          ...
          <div className="xl:col-span-1 space-y-12">
            ...
            <Card className="kali-card border-white/5 bg-black/60 p-12 rounded-[4rem] border-8 shadow-inner text-center relative overflow-hidden group">
               ...
               <h4 className="text-[14px] font-black text-primary uppercase tracking-[1em] mb-8 italic flex items-center justify-center gap-6">
                  <Boxes className="size-8 animate-pulse" /> LOGIC_STABILITY
               </h4>
               <div className="text-6xl font-black text-white italic gold-glow uppercase tracking-tighter group-hover:scale-105 transition-transform duration-1000">FIXED</div>
            ...
            {result ? (
                ...
                <CardHeader className="p-0 mb-12 border-b-8 border-white/5 pb-12 flex flex-row justify-between items-center bg-primary/5 rounded-t-[5rem] px-12 py-8">
                  <div className="flex items-center gap-10">
                     <div className="size-24 rounded-[2rem] bg-primary flex items-center justify-center border-4 border-black/30 shadow-3xl animate-neural">
                        <GitBranch className="size-12 text-black" />
                     </div>
                     <div>
              ...
              <div className="h-full min-h-[900px] border-[16px] border-dashed border-primary/10 rounded-[8rem] flex flex-col items-center justify-center text-center p-24 bg-black/40 group relative overflow-hidden transition-all hover:bg-primary/5 shadow-9xl">
                 <div className="relative mb-24 group-hover:scale-110 transition-transform duration-[6000ms]">
                    <Boxes className="size-[30rem] text-primary/10 animate-pulse" />
                 ...
                 <h3 className="text-7xl md:text-[15rem] font-headline font-bold text-white mb-10 tracking-tighter italic drop-shadow-9xl uppercase leading-none opacity-20">Awaiting Logic</h3>
                 <p className="text-muted-foreground max-w-6xl mx-auto leading-relaxed text-3xl md:text-7xl font-black italic opacity-30 uppercase tracking-[1em]">
                   "سيدي <span className="text-primary font-black gold-glow underline decoration-primary decoration-8 underline-offset-[24px] shadow-9xl uppercase tracking-[1.5em]">المعتصم بالله</span>، مصفوفة التفكير المطلق بانتظار نيتك؛ قدم الإحداثيات للاستنباط الاستراتيجي."
                 </p>
