        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-12 relative z-10 pb-48 flex-1">
           <div className="xl:col-span-1 space-y-12">
              ...
              <div className="space-y-6">
                  <Card className="kali-card border-blue-500/40 bg-black/60 p-10 rounded-[3rem] border-8 shadow-inner text-center relative overflow-hidden group">
                    ...
                    <h4 className="text-[14px] font-black text-blue-400 uppercase tracking-[1em] mb-6 italic flex items-center justify-center gap-6">
                        <DownloadCloud className="size-8 animate-pulse" /> CVE.ORG_ARCHIVE
                    </h4>
                    <div className="text-5xl font-black text-white italic gold-glow uppercase tracking-tighter">SIPHONING</div>
                  ...
                  <Card className="kali-card border-red-500/40 bg-black/60 p-10 rounded-[3rem] border-8 shadow-inner text-center relative overflow-hidden group">
                    ...
                    <div className="text-5xl font-black text-white italic gold-glow uppercase tracking-tighter">STABLE</div>
                  </Card>
              </div>
           ...
           <Card className="xl:col-span-3 kali-card border-primary/40 bg-black/99 rounded-[6rem] p-16 border-[12px] shadow-[0_0_250px_rgba(0,0,0,1)] flex flex-col group overflow-hidden relative min-h-[1100px] hierarchical-shadow">
              ...
              <CardHeader className="p-0 mb-16 border-b-8 border-white/5 pb-12 bg-primary/10 rounded-t-[5rem] px-16 py-10 flex flex-row justify-between items-center">
                 ...
                 {oracleResult && (
                    <Badge className="bg-emerald-600/30 text-emerald-500 border-[10px] border-emerald-500/40 px-16 py-8 rounded-full font-black text-5xl animate-pulse shadow-9xl uppercase tracking-[0.4em] italic">GLOBAL_DNA_SYNC</Badge>
                 )}
              </CardHeader>
                 ...
                 {oracleResult ? (
                   <div className="space-y-20 animate-in fade-in zoom-in-95 duration-1000 flex-1 flex flex-col">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                         ...
                         <Card className="bg-emerald-600/5 border-8 border-emerald-500/20 p-16 rounded-[4rem] hover:border-emerald-500 transition-all duration-1000 shadow-9xl relative overflow-hidden group/hw active:scale-95 cursor-crosshair h-full flex flex-col">
                            ...
                            <div className="flex justify-between items-start mb-12 relative z-10">
                               <div className="flex items-center gap-10">
                                  ...
                                  <div>
                                     <span className="text-4xl md:text-[6rem] font-black text-white italic uppercase tracking-tight leading-none">ARCHIVE_INSIGHT</span>
                                     <div className="text-[12px] text-emerald-500/60 font-black uppercase tracking-[0.8em] mt-6 italic">Master Vulnerability DNA</div>
                                  </div>
                               </div>
                               <Badge className="bg-emerald-600/30 text-emerald-500 border-4 border-emerald-500/40 px-10 py-3 rounded-full font-black text-3xl italic shadow-2xl">v78.7_OK</Badge>
                            </div>
                            <div className="p-12 bg-black border-4 border-primary/20 rounded-[3rem] shadow-inner space-y-8 italic flex-1 flex flex-col justify-center">
                               ...
                               <p className="text-3xl md:text-[5rem] text-gray-200 italic font-black leading-tight drop-shadow-9xl">"{oracleResult.archiveInsight || "أرشيف CVE.org مدمج بالكامل في عصب الإدراك؛ كافة مفاصل الضعف التاريخية والنشطة الآن تحت سيادتك."}"</p>
                            </div>
                         </Card>
                      </div>
                   </div>
