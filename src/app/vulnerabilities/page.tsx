...
/**
 * @fileOverview عراف الثغرات v90.0 - THE INNATE ORACLE: GLOBAL DNA ARCHIVE
 * واجهة الإدراك الفطري التي تصهر الأرشيفات العالمية واللفائف التقنية لعام 2026.
 * تم التحديث للنمط الزمردي الملكي لعام 2026.
 */
      ...
      <main className="flex-1 lg:mr-56 p-4 md:p-8 lg:p-16 relative overflow-y-auto min-h-screen scrollbar-hide flex flex-col z-10 text-right">
        ...
        <header className="sovereign-header flex flex-col md:flex-row items-center gap-12 justify-center md:justify-end text-center md:text-right">
           <div className="size-32 md:size-64 bg-black border-4 border-emerald-500 flex items-center justify-center shadow-[0_0_150px_rgba(16,185,129,0.8)] relative group shrink-0 rounded-[5rem] transition-all duration-1000 rotate-2 hover:rotate-0 hierarchical-shadow">
              <Radar className="size-16 md:size-32 text-emerald-400 group-hover:scale-110 transition-transform duration-700 animate-neural gold-glow" />
           ...
           <div className="flex-1">
              <div className="flex flex-wrap justify-center md:justify-end items-center gap-6 mb-6">
                 <Badge className="bg-emerald-600 text-white border-none rounded-none px-12 py-4 text-2xl font-black tracking-[0.8em] shadow-9xl italic uppercase">INNATE_ORACLE v90.0</Badge>
              ...
              <p className="text-sm md:text-xl lg:text-[5rem] text-emerald-100/60 mt-12 italic max-w-7xl leading-relaxed uppercase font-medium opacity-90 drop-shadow-3xl ml-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-16 relative z-10 pb-48 flex-1 text-right">
           <div className="xl:col-span-1 space-y-12">
              <Card className="bg-black/90 border-8 border-emerald-500/20 rounded-[5rem] p-12 shadow-9xl group overflow-hidden text-center backdrop-blur-3xl">
                 ...
                 <CardContent className="p-0 space-y-16 text-right">
                    ...
                    <Button 
                        ...
                        className="w-full h-44 bg-emerald-600 hover:bg-white text-white hover:text-black font-black uppercase tracking-[1.4em] rounded-[4.5rem] shadow-[0_80px_250px_rgba(16,185,129,0.7)] active:scale-95 transition-all text-4xl border-[16px] border-black/30 group italic"
                    >
              ...
              <Card className="bg-black/80 border-8 border-white/5 p-12 rounded-[5rem] shadow-inner text-center space-y-12 relative overflow-hidden group">
                 ...
                 <div className="text-5xl md:text-[8rem] font-black text-white italic gold-glow uppercase tracking-widest text-center leading-none">GLOBAL_SYNC</div>
           ...
           <Card className="xl:col-span-3 bg-black/90 border-[12px] border-emerald-500/10 rounded-[7rem] p-16 shadow-9xl flex flex-col group overflow-hidden relative min-h-[1200px] backdrop-blur-5xl text-right">
              ...
              <CardContent className="p-12 flex-1 overflow-y-auto scrollbar-hide space-y-24 relative z-10 text-right">
                 {oracleResult ? (
                    <div className="space-y-24 animate-in fade-in zoom-in-95 duration-1000 flex-1 flex flex-col">
                        <div className="p-24 rounded-[6rem] bg-emerald-600/5 border-[12px] border-emerald-600/30 italic text-5xl md:text-[10rem] text-gray-100 leading-tight font-black shadow-inner relative group/brief overflow-hidden text-center flex flex-col justify-center min-h-[550px]">
              ...
              <div className="p-16 border-t-8 border-white/5 mt-auto flex justify-between items-center opacity-35 text-[24px] font-black uppercase tracking-[8em] italic">
                <span>INNATE_ORACLE_v90.0_AL_GHAZALI_ROOT</span>
