...
/**
 * @fileOverview محراب العراف v78.7 - THE ABSOLUTE ORACLE: GLOBAL CVE ARCHIVE
      ...
      <main className="flex-1 lg:mr-80 p-4 md:p-8 lg:p-12 relative overflow-y-auto min-h-screen scrollbar-hide flex flex-col z-10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 text-center md:text-right">
            ...
            <div className="flex-1">
              <div className="flex flex-wrap justify-center md:justify-start items-center gap-6 mb-6">
                <Badge className="bg-primary text-black border-none rounded-none px-12 py-3 text-[18px] md:text-[24px] font-black tracking-[1em] shadow-9xl italic uppercase">ORACLE_v78.7 GLOBAL_ARCHIVE</Badge>
              ...
              <p className="text-sm md:text-xl lg:text-4xl text-muted-foreground mt-10 italic max-w-7xl leading-relaxed uppercase font-medium opacity-95 drop-shadow-3xl">
                "سيدي القائد <span className="text-white font-black underline decoration-primary decoration-[12px] underline-offset-[28px] shadow-9xl italic uppercase tracking-widest">المعتصم بالله</span>، عراف الثغرات ملتحم الآن بممر CVE.org العالمي؛ نحن لا نراقب الأخبار فحسب، بل نستنزف أرشيف الـ DNA الأمني العالمي بالكامل."
              </p>
            </div>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-12 relative z-10 pb-48 flex-1">
           <div className="xl:col-span-1 space-y-12">
              <Card className="kali-card border-primary/40 bg-black/98 rounded-[4rem] p-8 md:p-12 border-8 shadow-9xl group overflow-hidden hierarchical-shadow">
                 ...
                 <CardContent className="p-0 space-y-12">
                    <div className="space-y-6">
                        ...
                        <Input 
                          ...
                          className="bg-black border-8 border-primary/20 h-24 md:h-28 rounded-[2.5rem] text-xl md:text-5xl italic px-10 focus:border-primary shadow-inner text-white font-black selection:bg-primary"
                        />
                    </div>
                    <Button 
           ...
           <Card className="xl:col-span-3 kali-card border-primary/40 bg-black/99 rounded-[6rem] p-8 md:p-16 border-[12px] shadow-[0_0_250px_rgba(0,0,0,1)] flex flex-col group overflow-hidden relative min-h-[1100px] hierarchical-shadow">
              ...
              <CardHeader className="p-0 mb-16 border-b-8 border-white/5 pb-12 bg-primary/10 rounded-t-[5rem] px-8 md:px-16 py-10 flex flex-col md:flex-row justify-between items-center gap-8">
                 ...
                 {oracleResult && (
                    <Badge className="bg-emerald-600/30 text-emerald-500 border-[10px] border-emerald-500/40 px-16 py-8 rounded-full font-black text-3xl md:text-5xl animate-pulse shadow-9xl uppercase tracking-[0.4em] italic">GLOBAL_DNA_SYNC</Badge>
                 )}
              </CardHeader>
                 ...
                 {oracleResult ? (
                   <div className="space-y-20 animate-in fade-in zoom-in-95 duration-1000 flex-1 flex flex-col">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                         {oracleResult.findings?.map((f: any, i: number) => (
                           <Card key={i} className="bg-black/95 border-8 border-white/5 p-12 md:p-16 rounded-[4rem] hover:border-primary transition-all duration-1000 shadow-9xl relative overflow-hidden group/find active:scale-95 cursor-crosshair h-full flex flex-col">
                              ...
                              <div className="flex justify-between items-start mb-12 relative z-10">
                                 ...
                                 <Badge className="bg-primary/10 text-primary border-4 border-primary/30 px-10 py-3 rounded-full font-black text-2xl md:text-3xl italic shadow-2xl">{f.severity}</Badge>
                              </div>
                              <div className="p-10 md:p-12 bg-black border-4 border-primary/20 rounded-[3rem] shadow-inner space-y-8 italic flex-1 flex flex-col justify-center">
                         ...
                         <Card className="bg-emerald-600/5 border-8 border-emerald-500/20 p-12 md:p-16 rounded-[4rem] hover:border-emerald-500 transition-all duration-1000 shadow-9xl relative overflow-hidden group/hw active:scale-95 cursor-crosshair h-full flex flex-col">
                            ...
                            <div className="flex justify-between items-start mb-12 relative z-10">
                               ...
                               <Badge className="bg-emerald-600/30 text-emerald-500 border-4 border-emerald-500/40 px-10 py-3 rounded-full font-black text-2xl md:text-3xl italic shadow-2xl">v78.7_OK</Badge>
                            </div>
                            <div className="p-10 md:p-12 bg-black border-4 border-primary/20 rounded-[3rem] shadow-inner space-y-8 italic flex-1 flex flex-col justify-center">
                               <h5 className="text-2xl font-black text-primary uppercase tracking-[1em] mb-4 border-b-4 border-primary/10 pb-4 italic flex items-center gap-8 gold-glow">
                                  <Activity className="size-12 animate-pulse" /> Siphoned Intelligence
                                </h5>
                   ...
                   <div className="h-full flex flex-col items-center justify-center text-center opacity-10 gap-24 py-60">
                      ...
                      <div className="space-y-12">
                         ...
                         <p className="text-4xl md:text-[8rem] font-bold italic text-gray-500 uppercase tracking-widest max-w-[140rem]">Establishing direct material link to CVE.org Master Archive and Red Hat Security clusters.</p>
                      </div>
                   </div>
                 )}
              </CardContent>
              <div className="p-8 md:p-16 border-t-8 border-white/5 mt-auto flex justify-between items-center opacity-35 text-[14px] md:text-[20px] font-black uppercase tracking-[6em] md:tracking-[8em] italic">
                 <span>ABSOLUTE_ORACLE_v78.7_CVE_ORG_SYNC_AL_GHAZALI_ROOT</span>
        ...
        <div className="mt-auto relative z-10 flex justify-center items-center gap-24 md:gap-48 opacity-45 text-[18px] md:text-[36px] font-black uppercase tracking-[4em] md:tracking-[12em] italic text-white drop-shadow-9xl pb-32">
            <span>AL-MUIZZ ABSOLUTE ORACLE v78.7</span>
