  ...
  const handleConsult = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/execute', {
          ...
          body: JSON.stringify({ type: 'smart_route', command: `cve_search ${query}`, target: query })
      });
           ...
           <div className="xl:col-span-1 space-y-12">
              ...
              <Card className="kali-card border-white/5 bg-black/60 p-8 rounded-[3.5rem] border-8 shadow-inner relative overflow-hidden group text-right">
                 <h4 className="text-[14px] font-black text-primary uppercase tracking-[0.8em] mb-8 italic flex items-center justify-center gap-6">
                    <LayoutGrid className="size-8 animate-pulse" /> ORACLE_KNOT_MAP (24)
                 </h4>
                 ...
                 <div className="mt-8 text-[10px] font-black uppercase tracking-widest text-muted-foreground italic text-center">Predictive_Innate_Status: v78.8</div>
              </Card>
