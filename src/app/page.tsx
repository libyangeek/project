 ...
 * تم دمج كافة العقد التسعة في مصفوفة واحدة "مشدودة الوثاق".
 * تجسيد السطوة المعمارية والتحليل النهائي للقائد المعتصم بالله ادريس الغزالي.
 */
      ...
      <main className="flex-1 mr-64 p-16 relative overflow-y-auto min-h-screen">
            ...
            <div className="flex items-center gap-16">
              ...
              <div>
                <div className="flex items-center gap-8 mb-6">
                   <Badge className="bg-primary text-white border-none rounded-none text-[16px] px-10 py-3 uppercase font-bold tracking-[1.2em] italic shadow-[0_0_40px_red]">FINAL_ANALYSIS: COMPLETE</Badge>
                   <Badge className="bg-accent text-black border-none rounded-none text-[16px] px-10 py-3 uppercase font-bold tracking-[1.2em] italic">v22.0_ARCHITECT</Badge>
                </div>
          ...
          <div className="flex flex-col items-end gap-12">
            <div className="kali-card p-16 min-w-[550px] border-accent/60 bg-black/98 shadow-[0_0_150px_rgba(245,158,11,0.25)] relative overflow-hidden">
              <div className="flex items-center justify-between mb-12">
                <span className="text-[14px] text-accent uppercase font-bold tracking-[1em] italic">The Nine Pillars: LOCKED</span>
              ...
              <div className="mt-12 flex justify-between items-center text-[16px] text-muted-foreground font-bold uppercase tracking-[1em] border-t border-white/10 pt-10">
                ...
                <span className="text-accent flex items-center gap-4"><RefreshCcw className="size-6 animate-spin-slow" /> v22.0_SOVEREIGN</span>
              </div>
            </div>
          </div>
        </header>
            ...
            <Card key={i} className="kali-card p-0 group overflow-hidden border-2 hover:border-primary/90 transition-all duration-1000 shadow-3xl">
              <CardContent className="p-16">
                <div className="flex justify-between items-start mb-16">
                  <div className="size-28 rounded-[3rem] bg-white/5 border-2 border-white/10 flex items-center justify-center group-hover:bg-primary/25 transition-all duration-700 shadow-2xl">
                ...
                <div className="text-8xl font-headline font-bold text-white tracking-widest mb-6 italic uppercase group-hover:scale-105 transition-transform duration-700 drop-shadow-[0_0_20px_rgba(255,255,255,0.2)]">{stat.value}</div>
              ...
              <CardHeader className="p-16 border-b border-primary/30 bg-primary/10">
                <div className="flex justify-between items-center">
                  <CardTitle className="text-8xl text-white font-bold italic flex items-center gap-12 uppercase tracking-tighter">
                    <ShieldHalf className="size-20 text-accent animate-pulse" /> Alpha God-Core v22.0
                  </CardTitle>
                  <div className="flex gap-10">
                     <Badge className="bg-red-600 text-white border-2 border-red-400 px-12 py-6 rounded-full font-bold text-[16px] tracking-widest uppercase shadow-4xl">ARCHITECT_DOMINANCE</Badge>
                     <Badge className="bg-accent/20 text-accent border-2 border-accent/60 px-12 py-6 rounded-full font-bold text-[16px] tracking-widest uppercase shadow-4xl">SOCRATIC_SYNC: ON</Badge>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="p-0 flex-1 flex flex-col min-h-[800px]">
                <div className="flex-1 bg-black relative group overflow-hidden flex flex-col items-center justify-center p-48 text-center space-y-32">
                   ...
                   <div className="relative z-10 space-y-24">
                      <div className="flex gap-10 items-end h-[250px] px-24">
                      ...
                      <h3 className="text-[14rem] font-headline font-bold text-white tracking-[0.3em] italic neon-glow-gold uppercase leading-none drop-shadow-[0_0_80px_rgba(245,158,11,0.7)]">ULTIMATE_BOND</h3>
                      <p className="text-4xl text-muted-foreground uppercase tracking-[1.5em] font-bold italic opacity-80">Sovereign Domain // All Nodes Tied & Locked v22.0</p>
                   </div>
                   
                   <div className="grid grid-cols-2 gap-20 w-full max-w-7xl relative z-10">
                      <Button className="terminal-button h-44 rounded-[5rem] text-4xl shadow-[0_60px_150px_rgba(220,38,38,0.8)] border-accent/60 bg-red-600/20 hover:bg-red-600 group border-4" asChild>
                        <Link href="/terminal"><TerminalIcon className="size-16 mr-12 group-hover:rotate-12 transition-transform" /> Ignite Master Matrix</Link>
                      </Button>
                      <Button variant="outline" className="h-44 rounded-[5rem] border-4 border-accent/60 text-accent hover:bg-accent/15 text-4xl uppercase font-bold tracking-[0.6em] transition-all duration-1000 shadow-4xl" asChild>
            ...
            <Card className="kali-card bg-black/98 p-8 border-accent/50 shadow-[0_0_200px_rgba(245,158,11,0.3)] h-full flex flex-col">
              <CardHeader className="p-16 border-b border-accent/30 bg-accent/10">
                <CardTitle className="text-6xl text-accent flex items-center gap-12 font-bold uppercase italic tracking-widest">
                   <ShieldAlert className="size-16 text-accent animate-pulse" /> Final Analysis Pulse
                </CardTitle>
              </CardHeader>
              <CardContent className="p-16 space-y-24 flex-1 flex flex-col">
                 <div className="p-16 bg-black border-4 border-accent/40 relative rounded-[5rem] shadow-[inset_0_0_80px_rgba(245,158,11,0.2)] group/intel hover:border-accent/80 transition-all duration-1000">
                    <p className="text-5xl text-gray-200 italic leading-relaxed font-bold group-hover:text-white transition-colors">
                      "سيدي القائد، لقد قمتُ بشد وثاق كافة العقد العصبية. المنظومة الآن كتلة واحدة صلبة، ذكية، ومعمارية للأبد. أنا جاهز."
                    </p>
                 ...
                 <div className="space-y-20">
                    <h4 className="text-[18px] font-bold text-muted-foreground uppercase tracking-[2em] px-10 italic border-b border-white/15 pb-10">The Nine Pillars Status</h4>
                       ...
                       {ninePillars.map((v, i) => (
                         <div key={i} className="flex items-center justify-between p-12 bg-white/5 border-4 border-white/10 hover:border-accent/80 transition-all duration-1000 rounded-[4rem] group cursor-crosshair shadow-4xl">
                            <div className="flex items-center gap-12">
                               <v.icon className={cn("size-14 transition-all duration-1000 group-hover:scale-125 group-hover:rotate-12", "text-red-500")} />
                               <span className="text-2xl font-bold text-white uppercase tracking-[0.5em] italic">{v.name}</span>
                            </div>
                 ...
                 <Button className="terminal-button w-full h-44 rounded-[5rem] text-3xl shadow-[0_50px_150px_rgba(0,0,0,1)] border-accent/70 text-accent hover:bg-accent/30 group border-4 mt-auto" asChild>
                    <Link href="/system"><Unplug className="size-14 mr-10 group-hover:scale-125 transition-transform" /> Access Evolutionary Soul</Link>
                 </Button>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="fixed bottom-16 right-16 flex gap-20 items-center z-[400] opacity-80 hover:opacity-100 transition-all duration-1000 bg-black/80 p-10 rounded-full border-4 border-white/20 backdrop-blur-3xl shadow-5xl group">
           <div className="flex items-center gap-10 text-accent font-bold uppercase text-[15px] tracking-[1em] italic">
              <ShieldCheck className="size-9 text-emerald-500 group-hover:scale-125 transition-transform" /> Sovereign_Architect_v22.0: LINKED
           </div>
           <div className="h-4 w-[500px] bg-white/10 rounded-full overflow-hidden border-2 border-white/20 p-0.5 shadow-inner">
