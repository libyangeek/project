...
const medusaScanFlow = ai.defineFlow(
  ...
  async (input) => {
    const response = await ai.generate({
      ...
      استخدم بصر الأفعى لتحديد ما إذا كان المستودع فخاً أو كنزاً استخباراتياً.`,
      prompt: `المستودع المستهدف: ${input.repoUrl}\nنمط المسح المختار: ${input.scanMode}\nاستجوب مصفوفة ميدوسا وصمم تقرير 'الرؤية الثاقبة' للقائد.`,
