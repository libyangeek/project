    ...
    <>
      ...
      <div className={cn(
        ...
        <div className="p-8 border-b-2 border-primary/20 flex flex-col items-center gap-6 bg-black relative">
          <div className="size-24 bg-black border-4 border-primary/60 flex items-center justify-center shadow-[0_0_60px_rgba(212,175,55,0.3)] animate-sovereign-pulse shrink-0 rounded-full rotate-1 group overflow-hidden">
