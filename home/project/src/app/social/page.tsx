                 ...
                 {nexusResult ? (
                    <div className="space-y-20 animate-in fade-in zoom-in-95 duration-1000 flex-1 flex flex-col">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                            <Card className="bg-black/95 border-8 border-white/5 p-16 rounded-[4rem] shadow-9xl relative group/vault overflow-hidden">
                                ...
                                <div className="text-3xl md:text-6xl text-gray-300 italic font-black leading-snug selection:bg-primary drop-shadow-3xl">
                                ...
                                <div className="grid grid-cols-1 gap-8">
                                    {nexusResult.forgedWordlistSnippet.map((key: string, idx: number) => (
                                        <div key={idx} className="p-10 rounded-[2.5rem] bg-white/5 border-4 border-emerald-500/30 hover:border-emerald-500 transition-all text-center shadow-inner group/key">
                                            <span className="text-4xl md:text-8xl font-black text-white italic tracking-widest group-hover/key:text-emerald-400">{key}</span>
                                        </div>
                                    ))}
                                </div>
                            </Card>
